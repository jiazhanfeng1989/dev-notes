...
- [GoJson](https://github.com/goccy/go-json) GoJson is a high-performance, flexible, and easy-to-use JSON library for Go.
- [UUID](https://github.com/google/uuid) UUID is a library for generating and parsing UUIDs.
- [Ptr](https://github.com/gotidy/ptr) Ptr is a library for generating and parsing pointers.
- [Oapi-codegen Tools](https://github.com/oapi-codegen) Oapi-codegen is a library for generating Go code from OpenAPI 3.0 specifications.
- [Oapi-codegen Runtime](https://github.com/oapi-codegen/runtime) Oapi-codegen runtime is a library for working with OpenAPI 3.0 specifications.
- [Gorm](https://github.com/go-gorm/gorm) Gorm is an ORM library for Go.
- [GoGeos](github.com/paulsmith/gogeos) GoGeos is a library for working with geospatial data.
- [GoPolyline](https://github.com/twpayne/go-polyline) GoPolyline is a library for working with polyline data.
- [Golang-LRU](https://github.com/hashicorp/golang-lru/v2) Golang-LRU is a library for working with LRU cache.
- [Geohash](https://github.com/mmcloughlin/geohash) Geohash is a library for working with geohash data.
